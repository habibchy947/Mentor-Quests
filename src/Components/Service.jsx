...
const Service = ({ service }) => {
    ...
    console.log(service)
    return (
        <div className="card relative bg-base-100 rounded-3xl shadow-md outline-2 border-2  border-orange-200 hover:border-none">
            ...
            <div className="card-body px-3 py-3 space-y-2">
                ...
                <h2 className="card-title font-medium text-black">{serviceName}</h2>
            ...
            <div className='h-20 -top-8 -right-5 w-20 text-xl font-bold absolute text-white rounded-full text-center bg-orange-400 flex items-center justify-center'>{pricing}</div>
        </div>
    );
};
